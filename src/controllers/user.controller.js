...
const updateAccountDetails = asyncHandler(async (req, res) => {
  // req.body se fullName and email le lo
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  if (!username) {
    throw new ApiError(400, "Username is required to update channel profile");
  }
      ...
      $lookup: {
        ...
        pipeline: [
          ...
          },
          {
            $addFields: {
              owner: {
                $first: "$owner", // getting first element of owner array
              },
            },
          },
        ],
